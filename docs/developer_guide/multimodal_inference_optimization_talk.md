...
+ 算子层可能优化：
  + Masked_Scatter：shape：6102,8192;6102,8192;2592,8192，45ms。内部实现可能用Scalar操作完成的
  + 多模态旋转位置编码：可以考虑像LLM Decoder一样做cos_sin_cache的融合算子
  + MatMul：K轴非256B对齐，shape：28512,864;1280,864;1280，597us。在做了TP之后，MLP中的第二个MatMul K轴会被切分，可能导致这个问题。对于权重矩阵占大头的，可以考虑先转置权重，让权重矩阵内轴512B对齐优化。


bs=2，共4张512x512图片，raw patch:10368

![image-20260702163253169](https://zed-typora-image.oss-cn-hangzhou.aliyuncs.com/image-20260702163253169.png)

Prompt token:6102

![image-20260702163525862](https://zed-typora-image.oss-cn-hangzhou.aliyuncs.com/image-20260702163525862.png)
